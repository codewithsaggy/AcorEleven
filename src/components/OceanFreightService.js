...
function OceanFreightService() {
  return (
        <>
                <SEO title="Acor Eleven - Ocean Freight Services"  description="" />
                    ...
                    <div className="container">
                        <div className="row align-items-center mb-5 pb-5">
                            <div className="col-lg-6">
                                <h1 className='text-uppercase streamline-text'>Ocean Freight<br/> Forwarding</h1>
...
export default OceanFreightService;
