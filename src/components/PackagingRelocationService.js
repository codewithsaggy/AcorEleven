...
function PackagingRelocationService() {
  return (
        <>
        <SEO title="Acor Eleven -  Packaging Relocation Services"  description="" />
                    ...
                    <div className="container">
                        <div className="row align-items-center mb-5 pb-5">
                            <div className="col-lg-6">
                                <h1 className='text-uppercase streamline-text'>Packaging Relocation<br/> Services</h1>
...
export default PackagingRelocationService;
