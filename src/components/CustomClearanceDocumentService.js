...
function CustomClearanceDocumentService() {
  return (
        <>
        
        <SEO title="Acor Eleven - Custom Clearance Services"  description="" />
                    ...
                    <div className="container">
                        <div className="row align-items-center mb-5 pb-5">
                            <div className="col-lg-6">
                                <h1 className='text-uppercase streamline-text'>Custom Clearance<br/> Forwarding</h1>
...
export default CustomClearanceDocumentService;
