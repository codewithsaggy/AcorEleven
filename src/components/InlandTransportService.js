...
function InlandTransportService() {
  return (
        <>
        <SEO title="Acor Eleven - Inland Transport Services"  description="" />
                    ...
                    <div className="container">
                        <div className="row align-items-center mb-5 pb-5">
                            <div className="col-lg-6">
                                <h1 className='text-uppercase streamline-text'>Inland Transport<br/> Services</h1>
...
export default InlandTransportService;
