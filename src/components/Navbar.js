...
import 'bootstrap/dist/js/bootstrap.bundle.min'; // Import Bootstrap utilities
...
function Navbar() {
  ...
  const [otpSent, setOtpSent] = useState(false); // New state for OTP feedback
  ...
  const sendOtp = async (e) => {
    ...
    setLoading(true);
    setOtpSent(false); // Reset feedback before sending OTP
  ...
  const handleOpenModal = () => {
    ...
    const handleCloseModal = () => {
      ...
      if (modalDialog) {
        // Add the fadeOut animation class and remove the fadeIn class
        ...
        setTimeout(() => {
          ...
          if (modalElement) {
            ...
            modalDialog.classList.remove("animate__fadeOut"); // Reset animation state
            setShowModal(false);
          }
        }, 300); // Adjust timeout to match animation duration (default 500ms)
      }
    };    
    ...
    <>
      ...
      {showModal && (
        <div
          ...
          aria-hidden="true"
          style={{ display: 'block' }}>
          <div className="modal-dialog modal-dialog-centered modal-minsize login-form animate__animated animate__fadeIn">
  ...
  <form onSubmit={handleSubmit}>
      <div className="mb-3">
        ...
        <button
          ...
          onClick={sendOtp}
          disabled={!email || loading || !isEmailValid} // Disable button while loading
        >
      ...
      {otpSent && ( // Feedback message for successful OTP
      ...
      <button
        ...
        disabled={loading || !email || !otp || !isEmailValid}
      >
        Login
      </button>
      <div className="mt-2">
                                ...
                                <div className="tab-pane fade show active" role="tabpanel">
                                   <form>
                                    <div className="mb-3">
                                      ...
                                      <input type="text" className="form-control" id="PhoneInput" placeholder="Enter Phone Number" required />
                                    ...
                                    <div className="mb-3">
                                      ...
                                      <input type="text" className="form-control" id="OTPInput" placeholder="Enter OTP" required />
                                    </div>
                                    <div className="mb-3">
                                      <p className='login-optn'>Didn’t get code? <a href='#'>Resend</a></p>
                                    </div>
                                    <button type="submit" className="btn site-btn w-100 mt-3" disabled>Login</button>
                                    <div className="mt-2">
